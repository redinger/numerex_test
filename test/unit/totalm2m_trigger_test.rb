...
class Totalm2mTriggerTest < Test::Unit::TestCase
 ...
 def test_reading_insert(table_number, event_type)
    ActiveRecord::Base.connection.execute("INSERT INTO ublip_totalm2m.EVENT_#{table_number} VALUES ('d739a720-0e43-4cfe-a2f2-065e87493766', '9354e7c9-74b8-4ba8-bbd5-6d1ec5d1d58c', '2007-10-11 18:02:02', '010657000847181', '010657000847181', 32.9393, -96.823, 0, 0, '2007-10-11 00:00:00', '1970-01-01 17:57:28', 211 ) ")
    ...
    assert_equal 'Thu Oct 11 10:57:28 -0500 2007', reading.created_at.to_s
    assert_equal event_type, reading.event_type
 end
 
 def test_reading_insert_old(table_number, event_type)
    ActiveRecord::Base.connection.execute("INSERT INTO ublip_totalm2m.EVENT_#{table_number} VALUES ('d739a720-0e43-4cfe-a2f2-065e87493766', '9354e7c9-74b8-4ba8-bbd5-6d1ec5d1d58c', '2007-10-11 18:02:02', '010657000847181', '010657000847181', 32.9393, -96.823, 0, 0, 211 ) ")
    readings = Reading.find(:all)
    assert_equal 1, readings.size
    reading = readings[0]
    assert_equal 32.9393, reading.latitude
    assert_equal -96.823, reading.longitude
    assert_equal 'Thu Oct 11 11:02:02 -0500 2007', reading.created_at.to_s
    assert_equal event_type, reading.event_type
 end
